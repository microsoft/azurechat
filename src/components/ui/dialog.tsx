...
export const Dailog = (): React.JSX.Element => (
  <Dialog.Root>
    ...
    <Dialog.Portal>
      ...
      <Dialog.Content className="data-[state=open]:animate-contentShow shadow-[hsl(206_22%_7%_/_35%)_0px_10px_38px_-10px,'_hsl(206_22%_7%_/_20%)_0px_10px_20px_-15px'] fixed left-1/2 top-1/2 max-h-[85vh] w-[90vw] max-w-[450px] -translate-x-1/2 -translate-y-1/2 rounded-[6px] bg-white p-[25px] focus:outline-none">
