...
>(({ status, ...props }, ref) => (
  <div className="w-full py-2">
    <div className="container max-w-3xl flex flex-col gap-1">
      ...
      <div className="backdrop-blur-xl bg-background/70 rounded-3xl overflow-hidden border-2 border-gray-600 dark:border-slate-300 focus-within:border-4 focus-within:border-blue-900">
