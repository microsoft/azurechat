...
> **TIP**: If an error occurs (and it is not a permissions issue), try running `azd up` again, as there may have been a temporary race condition.
...
> **Important**
> The application is protected by an identity provider - follow the steps in the [Add an identity provider](/docs/5-add-identity.md) section to configure authentication for your app.

[Next: Solution Overview](/docs/1-introduction.md)
